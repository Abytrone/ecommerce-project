<x-app-layout>
    <div
        ...
        <!-- Background Elements -->
        <div
            class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-100/50 rounded-full blur-[100px] -z-10 animate-pulse">
        </div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-emerald-100/50 rounded-full blur-[100px] -z-10 animate-pulse"
            style="animation-delay: 1s;"></div>

        <div
            class="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-2xl relative z-10 border border-stone-100">
            <div class="text-center">
                <h2 class="mt-2 text-3xl font-black text-stone-900 tracking-tight">Welcome Back</h2>
                <p class="mt-2 text-sm text-stone-500">
                    Or <a href="{{ route('register') }}"
                        class="font-bold text-teal-600 hover:text-teal-500 transition-colors">create a new account</a>
                </p>
            </div>
            ...
            <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-stone-600 cursor-pointer">
                            Remember me
                        </label>
                    </div>
